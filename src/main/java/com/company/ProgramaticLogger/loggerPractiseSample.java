//package com.company.ProgramaticLogger;
//
...
//
//public class loggerPractiseSample {
//
//    private static final Logger logger = LogManager.getLogger(loggerPractiseSample.class);
//
//
//    public static void main(String[] args) {
//        StackTraceElement ste = Thread.currentThread().getStackTrace()[1];
//        loggerPractiseSample.initializeYourLogger(ste.getFileName()+".log","%d %p %c [%t] %m%n");
//
